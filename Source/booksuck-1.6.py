...
while True:
    ...
    try:
        ...
        progressbar.close()
        print("\nTrying to reach the website returned an error:", e)
        print(f"Website: {url}")
        system("pause")
        exit()
    ...
    #Scraped page, paragraph finding
    while True:
        ...
        for l in list(range(0, len(removed_tags))):
    ...
    try:
        ...
        progressbar.close()
        print("Writing file to the folder in path: ", folder_path, " failed, with code: ", e)
